...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Créer un graphique et une série temporelle pour le HR
    ...
    audioChart.streamTo(document.getElementById("HRChart"), 1000);
    ...
    // Fonction pour mettre à jour la fréquence cardiaque
    function updateHeartRate() {
        var newHeartRate = Math.floor(Math.random() * (81 - 75) + 75);
        document.getElementById('heart_rate_value').textContent = newHeartRate;
    }

    // Mettre à jour la fréquence cardiaque toutes les 1000 millisecondes (1 seconde)
